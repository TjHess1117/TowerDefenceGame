...
public class AstroidShooter extends GameObject implements Clickable{
		...
		protected int x;
		protected int y;
		private double cooldownTime = 1.0;  // time that we are not allowed to fire
		public AstroidShooter(Control control, State state, boolean isMoving) {
		...
		public void update(double elapsedTime) {
			...
			cooldownTime -= elapsedTime;
				...
				if(cooldownTime <= 0 && !(e == null))
				{
					...
					{
						state.addGameObject(new AstroidShot(control,state, e, this));
